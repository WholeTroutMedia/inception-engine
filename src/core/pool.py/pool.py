...
class ConnectionManager:
    ...
    Provides a single interface to initialize, access, and monitor
    all connection pools. Designed for FastAPI lifespan integration.
    ...
    Usage:
        ...
        # In route handlers
        async with manager.db_session() as session:
            ...
        async with manager.redis_client() as client:
            ...
    """
